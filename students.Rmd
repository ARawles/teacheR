...
### NA and NULL and their differences

The R language has two closely related values, **NA** and **NULL**.

###### *NULL* indicates the absence of a value. It means that a value is missing (or has length zero).

On the other hand,

###### Missing values are represented by *NA* (not available). It can also be used to represent something that is invalid. You can have NA values for your major data types.
