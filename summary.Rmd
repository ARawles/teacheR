...
1. Why do `1 != 2` and `!(1 == 2)` both equal true?
    + The `!` operator it negates the following criteria. So our first statement is `1 not equal to 2` and whereas our second is `not 1 equal to 2`. But both of these evaluate to TRUE.
