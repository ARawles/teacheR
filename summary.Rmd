...
1. Why do `1 != 2` and `!(1 == 2)` both equal true?
    + The `!` operator is an inverter - it negates the following criteria. So both of our statements here mean `not equal to`, even though they're written differently.
