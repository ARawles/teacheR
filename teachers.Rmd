...
To better understand how functions operate, we need to understand how environments and scoping works in R. There's a separate chapter on [environments](environments.html) in this book, but we'll briefly look at how functions create environments.
