...
- Functions are named, and are always followed by () when used (even if it's blank)
...
```{r user_defined_functin_example, eval = TRUE}
...
```{r user_defined_functin_example_3, eval = TRUE}
...
```{r user_defined_functin_example_2, eval = TRUE}
