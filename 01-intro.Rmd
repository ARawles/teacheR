...
It's also worth remembering that you can have levels that don't appear in the data you have. For example, in a questionaire, you may provide the options "None", "Some", "All". But in your responses, you may see that no one chose the "None" option. In that case, you would still create a factor with three levels, even though only two of them appear.
